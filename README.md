...
Логи идут, но только во время выполнения этого скрипта. Вопрос. Он должен в фоне висеть получается, ибо он не завершается? А еще со временем падает еластик, хотя у меня выделено 4 ядра 4 гига оперативки, диск на 15гб, из которых свободно 7 и есть своп на 1 гб
